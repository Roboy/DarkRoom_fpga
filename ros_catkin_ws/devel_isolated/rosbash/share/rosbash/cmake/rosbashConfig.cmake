...
if("TRUE" STREQUAL "TRUE")
  set(rosbash_SOURCE_PREFIX /root/ros_catkin_ws/src/ros/rosbash)
  set(rosbash_DEVEL_PREFIX /root/ros_catkin_ws/devel_isolated/rosbash)
  set(rosbash_INSTALL_PREFIX "")
  set(rosbash_PREFIX ${rosbash_DEVEL_PREFIX})
else()
  set(rosbash_SOURCE_PREFIX "")
  set(rosbash_DEVEL_PREFIX "")
  set(rosbash_INSTALL_PREFIX /root/ros_catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbash' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_catkin_ws/src/ros/rosbash/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ros_catkin_ws/devel_isolated/rosbash/lib;/root/ros_catkin_ws/install_isolated/lib)
