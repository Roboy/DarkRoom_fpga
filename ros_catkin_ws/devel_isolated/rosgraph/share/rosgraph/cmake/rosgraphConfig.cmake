...
if("TRUE" STREQUAL "TRUE")
  set(rosgraph_SOURCE_PREFIX /root/ros_catkin_ws/src/ros_comm/rosgraph)
  set(rosgraph_DEVEL_PREFIX /root/ros_catkin_ws/devel_isolated/rosgraph)
  set(rosgraph_INSTALL_PREFIX "")
  set(rosgraph_PREFIX ${rosgraph_DEVEL_PREFIX})
else()
  set(rosgraph_SOURCE_PREFIX "")
  set(rosgraph_DEVEL_PREFIX "")
  set(rosgraph_INSTALL_PREFIX /root/ros_catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_catkin_ws/src/ros_comm/rosgraph/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ros_catkin_ws/devel_isolated/rosgraph/lib;/root/ros_catkin_ws/install_isolated/lib)
