...
if("TRUE" STREQUAL "TRUE")
  set(message_runtime_SOURCE_PREFIX /root/ros_catkin_ws/src/message_runtime)
  set(message_runtime_DEVEL_PREFIX /root/ros_catkin_ws/devel_isolated/message_runtime)
  ...
  set(message_runtime_INSTALL_PREFIX /root/ros_catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'message_runtime' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_catkin_ws/src/message_runtime/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ros_catkin_ws/devel_isolated/message_runtime/lib;/root/ros_catkin_ws/install_isolated/lib)
