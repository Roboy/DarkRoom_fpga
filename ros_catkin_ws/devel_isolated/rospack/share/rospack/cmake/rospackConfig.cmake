...
if("TRUE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /root/ros_catkin_ws/src/rospack)
  set(rospack_DEVEL_PREFIX /root/ros_catkin_ws/devel_isolated/rospack)
  set(rospack_INSTALL_PREFIX "")
  set(rospack_PREFIX ${rospack_DEVEL_PREFIX})
else()
  set(rospack_SOURCE_PREFIX "")
  set(rospack_DEVEL_PREFIX "")
  set(rospack_INSTALL_PREFIX /root/ros_catkin_ws/install_isolated)
...
if(NOT "/root/ros_catkin_ws/src/rospack/include;/usr/local/include;/usr/include " STREQUAL " ")
  set(rospack_INCLUDE_DIRS "")
  set(_include_dirs "/root/ros_catkin_ws/src/rospack/include;/usr/local/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_catkin_ws/src/rospack/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rospack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rospack;/usr/lib/libpython2.7.so;/usr/local/lib/libboost_filesystem.so;/usr/local/lib/libboost_program_options.so;/usr/local/lib/libboost_system.so;/usr/lib/libtinyxml.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ros_catkin_ws/devel_isolated/rospack/lib;/root/ros_catkin_ws/install_isolated/lib)
