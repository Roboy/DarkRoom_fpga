...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /root/ros_catkin_ws/src/ros_comm/rosbag)
  set(rosbag_DEVEL_PREFIX /root/ros_catkin_ws/devel_isolated/rosbag)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX /root/ros_catkin_ws/install_isolated)
...
if(NOT "/root/ros_catkin_ws/src/ros_comm/rosbag/include " STREQUAL " ")
  set(rosbag_INCLUDE_DIRS "")
  set(_include_dirs "/root/ros_catkin_ws/src/ros_comm/rosbag/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_catkin_ws/src/ros_comm/rosbag/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ros_catkin_ws/devel_isolated/rosbag/lib;/root/ros_catkin_ws/install_isolated/lib)
