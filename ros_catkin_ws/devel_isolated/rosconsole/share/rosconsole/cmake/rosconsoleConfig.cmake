...
if("TRUE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /root/ros_catkin_ws/src/ros_comm/rosconsole)
  set(rosconsole_DEVEL_PREFIX /root/ros_catkin_ws/devel_isolated/rosconsole)
  ...
  set(rosconsole_INSTALL_PREFIX /root/ros_catkin_ws/install_isolated)
...
if(NOT "/root/ros_catkin_ws/src/ros_comm/rosconsole/include;/usr/local/include " STREQUAL " ")
  set(rosconsole_INCLUDE_DIRS "")
  set(_include_dirs "/root/ros_catkin_ws/src/ros_comm/rosconsole/include;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_catkin_ws/src/ros_comm/rosconsole/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole;rosconsole_print;rosconsole_backend_interface;/usr/local/lib/libboost_regex.so;/usr/local/lib/libboost_system.so;/usr/local/lib/libboost_thread.so;/usr/local/lib/libboost_chrono.so;/usr/local/lib/libboost_date_time.so;/usr/local/lib/libboost_atomic.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ros_catkin_ws/devel_isolated/rosconsole/lib;/root/ros_catkin_ws/install_isolated/lib)
